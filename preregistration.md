...
16 participants with normal or corrected-to-normal vision will complete the study.

### Materials

- **Laptop**: Participants used their own devices to present visual stimuli for precisely controlled durations
...
1. Participants are instructed to sit at a comfortable viewing distance from their laptop
2. On each trial:
...
3. Trial distribution:
   ...
   - Total: approximately 350 trials per participant
